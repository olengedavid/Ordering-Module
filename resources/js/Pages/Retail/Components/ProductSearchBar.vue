...
<template>
  <div class="search-container">
    ...
    <div class="dropdown-container region-dropdown">
      ...
      <div
        class="dropdown-menu region-dropdown-menu"
    ...
    <div class="dropdown-container filter-dropdown">
      <div class="dropdown-trigger" @click="toggleFilterDropdown">
        <span class="dropdown-label"> Filter by {{ getFilterSummary() }} </span>
        <div class="dropdown-arrow">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
      ...
      >
        ...
        <div class="select-all-container">
          <button class="select-all-btn" @click="selectAllCategories">
            Select All
          </button>
          <button class="select-all-btn" @click="unselectAllCategories">
            Unselect All
          </button>
        </div>
        <div
        ...
        <div class="select-all-container">
          <button class="select-all-btn" @click="selectAllManufacturers">
            Select All
          </button>
          <button class="select-all-btn" @click="unselectAllManufacturers">
            Unselect All
          </button>
        </div>
        <div
    ...
    <!-- Filter button -->
    <button class="filter-button" @click="applyAllFilters">Filter</button>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async fetchRegionsForRetailer() {
      try {
        const response = await axios.get(route("retailer.regions.search"), {
          params: {
            country: this.retailerCountry,
            per_page: 10,
          },
        });
        this.regions = response.data.data.map((region) => region.region);
      } catch (error) {
