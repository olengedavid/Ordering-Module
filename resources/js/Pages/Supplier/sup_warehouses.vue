<template>
  ...
  export default {
      ...
      return {
        ...
        warehouses: [
          ...
          },
          {
            ...
            email: 'lucy.akinyi@agritech.co.ke',
            phone: '+254 722 111 222',
            address: 'Kisumu Industrial Park',
            kraPin: 'B123456789P',
            country: 'Kenya',
            region: 'Kisumu',
            gps: '-0.0917,34.7680',
          ...
          },
          {
            ...
            email: 'james.mwangi@agritech.co.ke',
    ...
    computed: {
      ...
      sortedWarehouses() {
        const warehouses = [...this.filteredWarehouses];
        warehouses.sort((a, b) => {
      ...
      totalPages() {
        return Math.ceil(this.filteredWarehouses.length / this.perPage);
      },
      paginatedWarehouses() {
        const startIndex = (this.currentPage - 1) * this.perPage;
        const endIndex = startIndex + this.perPage;
        return this.sortedWarehouses.slice(startIndex, endIndex);
      }
    },
    created() {
