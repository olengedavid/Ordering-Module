          ...
          <div class="flex">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
              ...
              <NavLink
                ...
                class="inline-flex items-center opacity-50 cursor-not-allowed pointer-events-none"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
              ...
              <NavLink
                :href="route('supplier.inventories.index')"
                :active="route().current('supplier.inventories.*')"
                class="inline-flex items-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <NavLink
                :href="route('supplierwarehouse.index')"
                :active="route().current('supplierwarehouse.*')"
                class="inline-flex items-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <NavLink
                :href="route('supplier.users.index')"
                :active="route().current('supplier.users.*')"
                class="inline-flex items-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="hidden sm:ms-6 sm:flex sm:items-center">
            ...
            <div class="relative ms-3">
              <Dropdown align="right" width="48">
                ...
                <template #content>
                  <DropdownLink :href="route('supplier.details')">
                    Company Details
                  </DropdownLink>
                  <DropdownLink
                    :href="route('logout')"
      ...
      >
        ...
        <div class="border-t border-gray-200 pb-1 pt-4">
          ...
          <div class="mt-3 space-y-1">
            <ResponsiveNavLink :href="route('supplier.details')">
              Company Details
            </ResponsiveNavLink>
            <ResponsiveNavLink
              :href="route('logout')"
